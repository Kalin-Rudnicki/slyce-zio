...
final case class ExpandedGrammar2 private (
    startNt: Marked[String],
    initialNTGroups: List[ExpandedGrammar2.NTGroup],
    deDuplicatedNTGroups: List[ExpandedGrammar2.NTGroup],
)
object ExpandedGrammar2 {
  ...
  object fromGrammar {
    ...
    def apply(grammar: GrammarInput): ExpandedGrammar2 = {
